package com.andiandy.m101j.week2.hw2.a3.hw2_3.src.main.java.course;
...
public class BlogController {
    ...
    private void initializeRoutes() throws IOException {
        ...
        get(new FreemarkerBasedRoute("/",
									 "com/andiandy/m101j/week3/hw2_3/src/main/resources/freemarker/blog_template.ftl" ) {
            @Override
        ...
        post(new FreemarkerBasedRoute("/signup",
									  "com/andiandy/m101j/week3/hw2_3/src/main/resources/freemarker/signup.ftl" ) {
            @Override
        ...
        get(new FreemarkerBasedRoute("/signup",
									 "com/andiandy/m101j/week3/hw2_3/src/main/resources/freemarker/signup.ftl" ) {
            @Override
        ...
        get(new FreemarkerBasedRoute("/welcome",
									 "com/andiandy/m101j/week3/hw2_3/src/main/resources/freemarker/welcome.ftl" ) {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
        ...
        get(new FreemarkerBasedRoute("/login",
									 "com/andiandy/m101j/week3/hw2_3/src/main/resources/freemarker/login.ftl" ) {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                SimpleHash root = new SimpleHash();
        ...
        post(new FreemarkerBasedRoute("/login",
									  "com/andiandy/m101j/week3/hw2_3/src/main/resources/freemarker/login.ftl" ) {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
        ...
        get(new FreemarkerBasedRoute("/logout",
									 "com/andiandy/m101j/week3/hw2_3/src/main/resources/freemarker/signup.ftl" ) {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
        ...
        get(new FreemarkerBasedRoute("/internal_error",
									 "com/andiandy/m101j/week3/hw2_3/src/main/resources/freemarker/error_template.ftl" ) {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                SimpleHash root = new SimpleHash();
