package com.andiandy.m101j.week3.hw2_3.src.main.java.course;
...
public class BlogController {
    ...
    private void initializeRoutes() throws IOException {
        ...
        get(new FreemarkerBasedRoute("/post/:permalink",
									 "entry_template.ftl" ) {
            @Override
        ...
        get(new FreemarkerBasedRoute("/newpost",
        ...
        post(new FreemarkerBasedRoute("/newpost",
									  "newpost_template.ftl" ) {
            @Override
            protected void doHandle(Request request, Response response, Writer writer)
                    throws IOException, TemplateException {
        ...
        post(new FreemarkerBasedRoute("/newcomment",
									  "entry_template.ftl" ) {
            @Override
            protected void doHandle(Request request, Response response, Writer writer)
                    throws IOException, TemplateException {
        ...
        get(new FreemarkerBasedRoute("/post_not_found",
									 "post_not_found.ftl" ) {
            @Override
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                SimpleHash root = new SimpleHash();
